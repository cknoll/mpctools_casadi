    ...
    \begin{itemize}
        \item Windows/Linux/Mac zip file available at \clickurl{http://files.casadi.org}
            \begin{itemize}
                ...
                \item Windows 64 bit users, see the \hyperlink{specialnotes}{\textcolor{blue}{Special Notes}} slide
            \end{itemize}
...
\begin{frame}[allowframebreaks]{Scientific Python Options}
    ...
    \begin{itemize}
        \item Download from \clickurl{http://python-xy.github.io/}
...
\begin{frame}[label=specialnotes]{Special Notes}
    ...
    For Windows 64 bit, the official releases are bugged. Use a version from the ``commits'' folder on \clickurl{http://files.casadi.org}.
    \begin{itemize}
        \item E.g., commit \texttt{de2f632} from \winsixtyfour{https://sourceforge.net/}\hspace{0pt}\winsixtyfour{projects/casadi/files/CasADi/commits/de2f632/windows/}
