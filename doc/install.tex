...
\begin{frame}[allowframebreaks]{Installation}
    ...
    \begin{itemize}
        \item Download zipped package: \smallurl{https://bitbucket.org/rawlings-group/mpc-tools-casadi}
        \begin{itemize}
...
\begin{frame}[allowframebreaks]{Scientific Python Options}
    ...
    \begin{itemize}
        \item Download from \smallurl{https://www.continuum.io/downloads}
    ...
    \begin{itemize}
        ...
        \item Download from \smallurl{http://conda.pydata.org/miniconda.html}
    ...
    \begin{itemize}
        \item Download from \smallurl{https://code.google.com/p/pythonxy/}
...
\begin{frame}{Special Notes}
    ...
    \begin{itemize}
        \item E.g., \smallurl{https://sourceforge.net/projects/casadi/}\smallurl{files/CasADi/commits/de2f632/windows/}
